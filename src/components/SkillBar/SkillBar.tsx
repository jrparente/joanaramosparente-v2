...
function SkillBar() {
  return (
    <div className="mt-auto flex flex-col lg:flex-row items-center justify-center lg:gap-32 py-5 bg-neutral-900 md:mt-15 lg:mt-0 px-5 xs:px-10 sm:px-12 md:px-24 text-sm lg:text-base uppercase font-semibold text-white">
