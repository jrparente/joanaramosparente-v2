...
function SkillBar() {
  return (
    <div className="w-full flex flex-col lg:flex-row items-center justify-center lg:gap-32 py-5 bg-gray-200 mt-10 md:mt-15 lg:mt-0 px-5 xs:px-10 sm:px-12 md:px-24 uppercase font-semibold">
